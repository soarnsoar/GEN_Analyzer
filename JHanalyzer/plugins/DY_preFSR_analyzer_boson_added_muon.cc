...
//DY_preFSR_analyzer_boson_added_muon
//
//LHEEventProduct
//externalLHEProducer
//LHERunInfoProduct
...
class DY_preFSR_analyzer_boson_added_muon : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit DY_preFSR_analyzer_boson_added_muon(const edm::ParameterSet&);
      ~DY_preFSR_analyzer_boson_added_muon();
...
//
DY_preFSR_analyzer_boson_added_muon::DY_preFSR_analyzer_boson_added_muon(const edm::ParameterSet& iConfig)
...
DY_preFSR_analyzer_boson_added_muon::~DY_preFSR_analyzer_boson_added_muon()
{
...
void
DY_preFSR_analyzer_boson_added_muon::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
//////////////////////
   ...
   int leppid=13;//for Muon channel
...
void 
DY_preFSR_analyzer_boson_added_muon::beginJob()
{
  cout<<"beginjob"<<endl;
...
void 
DY_preFSR_analyzer_boson_added_muon::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
DY_preFSR_analyzer_boson_added_muon::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(DY_preFSR_analyzer_boson_added_muon);
