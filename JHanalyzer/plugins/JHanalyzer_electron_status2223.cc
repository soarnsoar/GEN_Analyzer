// -*- C++ -*-
//
// Package:    Analyzer/JHanalyzer_electron_status2223
// Class:      JHanalyzer_electron_status2223
// 
/**\class JHanalyzer_electron_status2223 JHanalyzer_electron_status2223.cc Analyzer/JHanalyzer_electron_status2223/plugins/JHanalyzer_electron_status2223.cc
...
class JHanalyzer_electron_status2223 : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit JHanalyzer_electron_status2223(const edm::ParameterSet&);
      ~JHanalyzer_electron_status2223();
...
//
JHanalyzer_electron_status2223::JHanalyzer_electron_status2223(const edm::ParameterSet& iConfig)
...
JHanalyzer_electron_status2223::~JHanalyzer_electron_status2223()
{
...
void
JHanalyzer_electron_status2223::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
//////////////////////
   ...
   for(int i =0; i<102;i++){
       trupdfweight[i]=LHEInfo->weights()[i].wgt/LHEInfo->originalXWGTUP();
   }
   ...
   for(int i = 0; i < gensize; ++ i) {///scan all gen particles
     ...
     if(id==23 && status==22) Z_i_status22=i;
...
void 
JHanalyzer_electron_status2223::beginJob()
{
...
void 
JHanalyzer_electron_status2223::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
JHanalyzer_electron_status2223::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(JHanalyzer_electron_status2223);
