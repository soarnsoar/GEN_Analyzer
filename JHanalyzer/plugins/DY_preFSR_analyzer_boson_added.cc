...
class DY_preFSR_analyzer_boson_added : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit DY_preFSR_analyzer_boson_added(const edm::ParameterSet&);
      ~DY_preFSR_analyzer_boson_added();
...
//
DY_preFSR_analyzer_boson_added::DY_preFSR_analyzer_boson_added(const edm::ParameterSet& iConfig)
...
DY_preFSR_analyzer_boson_added::~DY_preFSR_analyzer_boson_added()
{
...
void
DY_preFSR_analyzer_boson_added::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
DY_preFSR_analyzer_boson_added::beginJob()
{
  cout<<"beginjob"<<endl;
...
void 
DY_preFSR_analyzer_boson_added::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
DY_preFSR_analyzer_boson_added::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(DY_preFSR_analyzer_boson_added);
